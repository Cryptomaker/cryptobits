...
uint256 hashGenesisBlock("0xbf3ff0be80d2dbf3159515ffc1d026606ed26c8e12b45bcb899f7552f0853291");
...
const string strMessageMagic = "Cryptobits Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal cryptobits miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Cryptobits", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbf3ff0be80d2dbf3159515ffc1d026606ed26c8e12b45bcb899f7552f0853291");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Cryptobits-Made by muddafudda @ bitcointalk";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1374170054; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 114112;

        if (fTestNet)
        {
            block.nTime    = 1374170054;
            block.nNonce   = 114112;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xa938bd62766291d8e80d9412990a8b6c45473813c41d0554e68265035b791436"));
